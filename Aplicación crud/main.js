...
const updateData = (index) => {
    ...
    document.getElementById('inputcountry').value = listPeople[index].pais;
    ...
    document.querySelector("#btnUpdate").onclick = function () {
        if (validarFormulario() == true) {
            ...
            listPeople[index].pais = document.getElementById('inputcountry').value;
